 ...
 */
package org.dbflute.utflute.seasar.sastruts;
...
/**
 * @author jflute
 * @since 0.5.0 (2014/12/03 Wednesday)
 */
public class ActionUrlPatternChecker implements PoliceStoryJavaClassHandler {
    ...
    protected void throwUrlPatternPropertyNotFoundException(Class<?> actionType, Method method, String urlPattern, Class<?> formType,
        ...
        br.addElement("    protected Foo" + _actionSuffix + " fooFlute;");
        br.addElement("  (o):");
        br.addElement("    @Resource");
        br.addElement("    protected Foo" + _actionSuffix + " foo" + _actionSuffix + ";");
        br.addItem("Action");
